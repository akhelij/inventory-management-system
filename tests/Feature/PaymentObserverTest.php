...
{
    #[Test]
    public function deleting_payment_recalculates_order_pay_due(): void
    {
        ...
        $order->refresh();
        $this->assertEquals(5000, $order->pay);
        $this->assertEquals(0, $order->due);

        // Delete the payment — observer should recalculate affected orders
        $payment->delete();
