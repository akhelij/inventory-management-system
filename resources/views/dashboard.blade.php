...
{{--                                            <a class="dropdown-item" href="#">Last 3 months</a>--}}
                            ...
                            <div class="progress progress-sm">
                                <div class="progress-bar bg-primary" style="width: {{$sales_growth_percentage}}%" role="progressbar" aria-valuenow="{{$sales_growth_percentage}}" aria-valuemin="0" aria-valuemax="100" aria-label="{{$sales_growth_percentage}}% Complete">
                                    <span class="visually-hidden">{{$sales_growth_percentage}}% Complete</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-baseline">
                                <div class="h1 mb-0 me-2">{{$revenue_amount}} MAD</div>
                                <div class="me-auto">
                                <span class="text-green d-inline-flex align-items-center lh-1">
                                  {{$revenue_growth_percentage}}% <!-- Download SVG icon from http://tabler-icons.io/i/trending-up -->
                                  <svg xmlns="http://www.w3.org/2000/svg" class="icon ms-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 17l6 -6l4 4l8 -8" /><path d="M14 7l7 0l0 7" /></svg>
                                </span>
                                </div>
                            </div>
                ...
                <div class="col-sm-4 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-baseline">
                                <div class="h1 mb-3 me-2">{{$new_customers_30days}}</div>
                                <div class="me-auto">
                                <span class="text-yellow d-inline-flex align-items-center lh-1">
                                  {{$percentage_of_total}}% <!-- Download SVG icon from http://tabler-icons.io/i/minus -->
