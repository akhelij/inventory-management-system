                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select
                                            ...
                                            <option value="HandCash" @selected(old('payment_type') === 'HandCash')>
                                                {{ __('Cash') }}
                                            </option>
                                            <option value="Cheque" @selected(old('payment_type') === 'Cheque')>
                                                {{ __('Cheque') }}
                                            </option>
                                            <option value="Exchange" @selected(old('payment_type') === 'Exchange')>
                                                {{ __('Lettre de change') }}
                                            </option>
                                        </select>
                                            ...
                                            <template x-for="(item, index) in cart" :key="item.uuid">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <span x-show="item.is_free" class="badge bg-success ms-1 small">{{ __('Gift') }}</span>
                                                    </td>
