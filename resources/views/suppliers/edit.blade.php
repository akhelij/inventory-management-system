                            ...
                            <div class="card-body">
                                <div class="row row-cards">
                                    <div class="col-md-12">
                                        ...
                                        <x-input name="email" label="{{ __('Email address') }}" :value="old('email', $supplier->email)" :required="true"/>
                                        <x-input name="shopname" label="{{ __('Shop name') }}" :value="old('shopname', $supplier->shopname)" :required="true"/>
                                        <x-input name="phone" label="{{ __('Phone number') }}" :value="old('phone', $supplier->phone)" :required="true"/>
                                    </div>
